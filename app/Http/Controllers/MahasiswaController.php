...
class MahasiswaController extends Controller
    ...
    public function insert(){
        $mahasiswa = new Mahasiswa;
        $mahasiswa->nim = '19203036';
        $mahasiswa->nama = 'Fadil';
        $mahasiswa->tanggal_lahir = '2001-12-21';
        $mahasiswa->ipk = 3.0;
        $mahasiswa->save();
        dump($mahasiswa);
    }
    ...
    public function update(){
        ...
        $mahasiswa->tanggal_lahir = '2003-03-03';
        $mahasiswa->ipk = 2.9;
        $mahasiswa->save();
        dump($mahasiswa);
    }
    ...
    public function find(){
        ...
        return
        view('tampil-mahasiswa',['mahasiswas' =>[$mahasiswa]]);
    }
    ...
    public function limit(){
        ...
        // $mahasiswa =
        Mahasiswa::orderBy('created_at','desc')->limit(2)->get();
        return view('tampil-mahasiswa',['mahasiswas' =>$mahasiswa]);
    }

    public function skipTake(){
        $mahasiswa =
        Mahasiswa::orderBy('ipk')->skip(1)->take(3)->get();
        return view('tampil-mahasiswa',['mahasiswas' =>$mahasiswa]);
    }
